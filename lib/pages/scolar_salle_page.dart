      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(14),
            border: Border.all(
                color: _ssBlue.withValues(alpha: 0.3)),
          ),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Row(
                children: [
                  Container(
                    ...
                    height: 40,
                    decoration: BoxDecoration(
                      color: _ssBlue.withValues(alpha: 0.15),
                      borderRadius: BorderRadius.circular(10),
                    ),
                    child: const Icon(Icons.videocam_outlined,
                        color: _ssBlue, size: 20),
                  ),
                  const SizedBox(width: 12),
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        Text('Visioconférence',
                            style: TextStyle(
                                ...
                                fontSize: 14,
                                fontWeight: FontWeight.w600)),
                        Text('Rejoignez la visio du groupe',
                            style: TextStyle(
                                color: Colors.white38, fontSize: 12)),
                      ],
                    ),
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  onPressed: () {
                    // TODO: implement WebRTC/Jitsi integration
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content:
                            Text('Visioconférence : bientôt disponible'),
                  ...
                  style: OutlinedButton.styleFrom(
                    foregroundColor: _ssBlue,
                    side: BorderSide(
                        color: _ssBlue.withValues(alpha: 0.5)),
                    padding:
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              const Text('Tableau blanc collaboratif',
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 14,
                      fontWeight: FontWeight.w600)),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: _ssPurple.withValues(alpha: 0.1),
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(
                      color: _ssPurple.withValues(alpha: 0.3)),
                ),
