...
class LyceeNotesPage extends StatelessWidget {
  const LyceeNotesPage({super.key});
              ...
              Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(color: _color.withValues(alpha: 0.25), borderRadius: BorderRadius.circular(8)),
                    child: Text(_appreciation, style: TextStyle(color: _color, fontWeight: FontWeight.bold, fontSize: 12)),
                  ),
                  const SizedBox(height: 4),
                  Text('$nbNotes note${nbNotes > 1 ? 's' : ''}', style: const TextStyle(color: Colors.white60, fontSize: 11)),
                ],
              ),
            ],
          ),
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  Icon(_aboveMoy ? Icons.trending_up : Icons.trending_down,
                      color: _aboveMoy ? Colors.green : Colors.red, size: 14),
                  const SizedBox(width: 6),
                  Container(
                    padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                    decoration: BoxDecoration(color: _couleur.withValues(alpha: 0.15), borderRadius: BorderRadius.circular(20)),
            ...
            ...widget.notes.map((n) {
              ...
              return Padding(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: Text(n.intitule.isNotEmpty ? n.intitule : 'Note',
                          style: const TextStyle(color: Colors.white60, fontSize: 13)),
                    ),
                    Text('${n.note}/${n.bareme.toInt()}',
